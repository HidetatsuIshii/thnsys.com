...
const mapConfig = {
    hq: {
        image: IMG_HQ,
        areas: [
            { id: "1", name: "1 キッズ", top: 69.5, left: 27.4, width: 13.5, height: 12.3, color: "rgba(255, 215, 0, 0.5)" }, // ゴールド
            { id: "8", name: "8 契約室", top: 9, left: 27.4, width: 13.5, height: 13, color: "rgba(52, 152, 219, 0.5)" }, // ブルー

            // 2 & 3: 窓側（オレンジ系で統一）
            { id: "2", name: "2 窓側", top: 46.3, left: 27.4, width: 13.5, height: 12.3, color: "rgba(255, 120, 0, 0.45)" },
            { id: "3", name: "3 窓側", top: 31, left: 27.4, width: 13.5, height: 12.3, color: "rgba(255, 120, 0, 0.45)" },

            // 4 & 5: 中央（マゼンタ・パープル系で統一）
            { id: "4", name: "4 中央", top: 46.3, left: 48.9, width: 9.5, height: 12.3, color: "rgba(155, 89, 182, 0.45)" },
            { id: "5", name: "5 中央", top: 31, left: 47, width: 9.5, height: 12.3, color: "rgba(155, 89, 182, 0.45)" },

            // 6 & 7: 奥（エメラルド・グリーン系で統一）
            { id: "6", name: "6 奥", top: 9, left: 44.3, width: 9.5, height: 12.8, color: "rgba(26, 188, 156, 0.45)" },
            { id: "7", name: "7 奥", top: 9, left: 53.5, width: 9.5, height: 12.8, color: "rgba(26, 188, 156, 0.45)" },
        ]
    }
};
const START_HOUR = 7;
